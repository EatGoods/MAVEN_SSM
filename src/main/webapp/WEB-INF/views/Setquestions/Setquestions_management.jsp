...
<html>
    ...
    <ul class="toolbar">
      ...
      <li onClick="javascript:window.open('/Setquestions/Setquestions_management_add.jsp','scrollbars=yes,width=600,height=200')"><span><img src="<%= basePath %>/resources/images/t01.png" /></span>添加</li>
    ...
    <span class="x-right" style="line-height:25px">共有数据：${setquestions.size()}条</span></xblock>
  </div>
      <table class="tablelist">
         ...
         <tbody>
           <c:forEach items="${setquestions }" var="setquestions">
           	<tr>
           		<td>
                   <input type="checkbox" value="1" name="selected">
                </td>
           		<td>${setquestions.id }</td>
           		<td>${setquestions.questionsName }</td>
           		<td class="td-manage">
